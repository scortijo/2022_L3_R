...
# selon ce site: https://www.statology.org/filter-rows-that-contain-string-dplyr/ nous pouvons faire

expt1_col_background <- filter(expt1, grepl("Col", background))
distinct(expt1_col_background,background)


# selon ce site: https://sebastiansauer.github.io/dplyr_filter/ nous pouvons faire
