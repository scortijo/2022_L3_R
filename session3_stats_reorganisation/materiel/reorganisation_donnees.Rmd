...
> *Aide*: Aidez vous des exemples dans l'aide de R ou cherchez dans google
...
>**BONUS**:   
> Les lignes pour lesquelles le background contient **Col**   
> Vérifiez le résultat en sauvant le résultat dans un nouvel objet et en utilisant le fonction `distinct()`   
> *Aide*: Faites un recherche sur google pour trouver le resultat
