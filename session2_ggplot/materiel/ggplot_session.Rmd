...
>**BONUS**: Ajouter la géométrie dotplot plutôt que jitter. Utilisez l'aide (avec ?nom de fonction) pour savoir comment l'utiliser
...
> **BONUS**: Dessinez un scatter plot (`geom_point()`) entre `blade.length.mm` et `rosette.leaf.num` en colorant les points en fonction de `vernalization`, et changez la couleur des points pour que "NV" soit en bleu et "V" soit en orange.
