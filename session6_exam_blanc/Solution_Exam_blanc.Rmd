---
title: "Solution de l'examen blanc : Introduction à la bioinformatique pour la biologie végétale"
...
Pour l'examen blanc, vous allez analyser des données extraites de [Chiang et al., 2011](https://onlinelibrary.wiley.com/doi/10.1111/j.1365-294X.2011.05181.x). 
...
## Question 0  #     <span style="color: green;"> 2 points </span>
...
## Question 1       <span style="color: green;"> 1.5 points </span>
...
## Question 2      <span style="color: green;"> 2.5 points </span>
...
## Question 3     <span style="color: green;"> 8 points </span>
...
## Question 4      <span style="color: green;"> 4 points </span>
...
La différence est faible pour l'écotype Sf-2. 
...
## Question 5     <span style="color: green;"> 3 points </span>
...
![Capture d'écran de ePlant pour DOG1](capture d'écran eplant.png)
